...
impl WasiCtx {
    ...
    pub(crate) fn get_entry(&self, fd: Fd) -> Result<Rc<Entry>> {
    ...
    pub(crate) fn insert_entry(&self, entry: Entry) -> Result<Fd> {
    ...
    pub(crate) fn remove_entry(&self, fd: Fd) -> Result<Rc<Entry>> {
